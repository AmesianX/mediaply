...
function page_refresh() {
	if (profile_pic_upload_result!=1 && profile_pic_del_result!=1 && profile_bg_upload_result!=1 && profile_bg_del_result!=1) ajax_page_load('left_content', 'user_modify');
}
		...
		success: function(result) {
			if (result) {
				...
				*/
				...
				alert('아티스트 정보 변경완료.');
				ajax_page_load('left_content', 'user_modify');
			}
		}
	});
...
<img class="title_img" src="<?=$ft['img_path']?>/title_user_modify.jpg" alt="modify title" />

<img class="clear fleft mb10" src="<?=$ft['img_path']?>/title_user_info_modify.jpg" alt="modify user info title" />

<span class="clear fleft mb10 font_666666">회원 정보의 수정이 가능합니다.</span>
...
<table border="0" cellpadding="0" cellspacing="0" summary="회원 정보 수정 테이블" class="write_table mb10">
	...
	<tr>
		<th>마이페이지<br />배경</th>
		<td>
			<input type="file" name="profile_bg" id="profile_bg" class="fleft" />
			<? if ($user['profile_bg']) { ?>
...
<? if ($user['type']=='artist') { ?>
<img class="clear fleft mv10" src="<?=$ft['img_path']?>/title_user_artist_modify.jpg" alt="modify artist info title" />

<span class="clear fleft mb10 font_666666">아티스트 정보의 수정이 가능합니다.</span>
...
<table border="0" cellpadding="0" cellspacing="0" summary="아티스트 정보 수정 테이블" class="write_table mb10">
