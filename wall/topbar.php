...
<div id="left_div">
	...
	<? if ($is_mypage) { ?><span class="clear fleft btn mt5 profile_title" onclick="location.href='<?=$ft['wall_path']?>/ft.php?page=track';"><span class="profile_title"><img src="<?=$ft['img_path']?>/icon_album.jpg" alt=
"money icon" />&nbsp;판매내역</span></span><? } ?>
	<? if (!$is_mypage) { ?>
