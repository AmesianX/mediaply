...
<div id="right_title">승인 완료 앨범 상세보기</div>

<div id="content">

	<table border="0" cellpadding="0" cellspacing="0" summary="승인 완료 앨범 상세보기 테이블" class="view_table">
		<caption>승인 완료 앨범 상세보기 테이블</caption>
		<colgroup>
			<col width="120" />
			<col width="80" />
			<col width="" />
