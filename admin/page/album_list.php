...
<div id="right_title">승인 완료 앨범 리스트</div>

<div id="content">

	<table border="0" cellpadding="0" cellspacing="0" summary="승인 완료 앨범 리스트 테이블" class="list_table">
		<caption>승인 완료 앨범 리스트 테이블</caption>
		<colgroup>
			<col width="60" />
			<col width="120" />
			<col width="120" />
		...
		?>
		<tr class="btn" onclick="location.href='<?=$ft['adm_path']?>/?page=album_view&p_num=<?=$p_num?>&aid=<?=$row['aid']?>';">
			<td><?=$tmp_no--?></td>
