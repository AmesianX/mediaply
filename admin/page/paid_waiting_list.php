...
$where = 'WHERE 1 AND `state`="W" AND `price`>0';
...
<div id="right_title">입금 대기 내역</div>
...
<div id="content">
	...
	<table border="0" cellpadding="0" cellspacing="0" summary="입금 대기 내역 리스트 테이블" class="list_table" id="paid_list_table">
		<caption>입금 대기 내역 리스트 테이블</caption>
		<colgroup>
			<col width="60" />
			<col width="60" />
			<col width="120" />
